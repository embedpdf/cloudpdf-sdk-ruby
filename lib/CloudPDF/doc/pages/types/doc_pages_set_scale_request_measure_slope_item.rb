...
module CloudPDF
  module Doc
    module Pages
      module Types
        class DocPagesSetScaleRequestMeasureSlopeItem < Internal::Types::Model
          field :unit, -> { String }, optional: false, nullable: false

          field :conversion, -> { Integer }, optional: false, nullable: false

          field :fraction, -> { CloudPDF::Doc::Pages::Types::DocPagesSetScaleRequestMeasureSlopeItemFraction }, optional: true, nullable: false
          ...
          field :label_position, -> { CloudPDF::Doc::Pages::Types::DocPagesSetScaleRequestMeasureSlopeItemLabelPosition }, optional: true, nullable: false, api_name: "labelPosition"
        end
      end
    end
  end
