  ...
  module Doc
    module Metadata
      class Client
        ...
        #   )
        #
        # @return [Cloudpdf::Types::DocMetadataGet200Response]
        def get(request_options: {}, **params)
          ...
          request = Cloudpdf::Internal::JSON::Request.new(
            ...
            method: "GET",
            path: "v1/docs/#{URI.encode_uri_component(params[:doc_id].to_s)}/layers/#{URI.encode_uri_component(params[:layer_name].to_s)}/metadata",
            headers: headers,
          ...
          if code.between?(200, 299)
            Cloudpdf::Types::DocMetadataGet200Response.load(response.body)
          else
