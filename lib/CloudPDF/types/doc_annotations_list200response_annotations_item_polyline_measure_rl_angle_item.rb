...
module CloudPDF
  module Types
    class DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlAngleItem < Internal::Types::Model
      field :unit, -> { String }, optional: false, nullable: false

      field :conversion, -> { Integer }, optional: true, nullable: false

      field :fraction, -> { CloudPDF::Types::DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlAngleItemFraction }, optional: true, nullable: false
      ...
      field :label_position, -> { CloudPDF::Types::DocAnnotationsList200ResponseAnnotationsItemPolylineMeasureRlAngleItemLabelPosition }, optional: true, nullable: false, api_name: "labelPosition"
    end
  end
end
