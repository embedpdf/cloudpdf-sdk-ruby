...
module CloudPDF
  module Types
    class DocPagesSetScale200ResponseMetaCacheDelta < Internal::Types::Model
      ...
      field :pages, -> { Internal::Types::Array[CloudPDF::Types::DocPagesSetScale200ResponseMetaCacheDeltaPagesItem] }, optional: false, nullable: false
    end
  end
end
