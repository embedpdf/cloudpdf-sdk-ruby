...
module CloudPDF
  module Types
    class DocSignaturesAnalysis200ResponseCurrentPrimary < Internal::Types::Model
      field :rule, -> { String }, optional: false, nullable: false

      field :verdict, -> { CloudPDF::Types::DocSignaturesAnalysis200ResponseCurrentPrimaryVerdict }, optional: false, nullable: false
