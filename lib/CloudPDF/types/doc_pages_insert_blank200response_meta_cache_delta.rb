...
module CloudPDF
  module Types
    class DocPagesInsertBlank200ResponseMetaCacheDelta < Internal::Types::Model
      ...
      field :pages, -> { Internal::Types::Array[CloudPDF::Types::DocPagesInsertBlank200ResponseMetaCacheDeltaPagesItem] }, optional: false, nullable: false
    end
  end
end
