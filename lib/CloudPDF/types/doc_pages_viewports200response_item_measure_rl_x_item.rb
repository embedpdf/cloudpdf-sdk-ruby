...
module CloudPDF
  module Types
    class DocPagesViewports200ResponseItemMeasureRlXItem < Internal::Types::Model
      field :unit, -> { String }, optional: false, nullable: false

      field :conversion, -> { Integer }, optional: true, nullable: false

      field :fraction, -> { CloudPDF::Types::DocPagesViewports200ResponseItemMeasureRlXItemFraction }, optional: true, nullable: false
      ...
      field :label_position, -> { CloudPDF::Types::DocPagesViewports200ResponseItemMeasureRlXItemLabelPosition }, optional: true, nullable: false, api_name: "labelPosition"
    end
  end
end
