  ...
  module Doc
    module Pages
      class Client
        ...
        # @param params [CloudPDF::Doc::Pages::Types::DocPagesSetScaleRequest]
        ...
        #   )
        #
        # @return [CloudPDF::Types::DocPagesSetScale200Response]
        def set_scale(request_options: {}, **params)
          params = CloudPDF::Internal::Types::Utils.normalize_keys(params)
          request_data = CloudPDF::Doc::Pages::Types::DocPagesSetScaleRequest.new(params).to_h
          non_body_param_names = %w[docId layerName pon X-Document-Password]
          ...
          request = CloudPDF::Internal::JSON::Request.new(
            ...
            method: "PUT",
            path: "v1/docs/#{URI.encode_uri_component(params[:doc_id].to_s)}/layers/#{URI.encode_uri_component(params[:layer_name].to_s)}/pages/#{URI.encode_uri_component(params[:pon].to_s)}/scale",
            headers: headers,
            body: body,
          ...
          if code.between?(200, 299)
            CloudPDF::Types::DocPagesSetScale200Response.load(response.body)
          else
        ...
        #   )
        #
        # @return [Array[CloudPDF::Types::DocPagesViewports200ResponseItem]]
        def viewports(request_options: {}, **params)
          params = CloudPDF::Internal::Types::Utils.normalize_keys(params)
          headers = {}
          headers["X-Document-Password"] = params[:document_password] if params[:document_password]
          ...
          request = CloudPDF::Internal::JSON::Request.new(
            base_url: request_options[:base_url],
            method: "GET",
            path: "v1/docs/#{URI.encode_uri_component(params[:doc_id].to_s)}/layers/#{URI.encode_uri_component(params[:layer_name].to_s)}/pages/#{URI.encode_uri_component(params[:pon].to_s)}/viewports",
            headers: headers,
            request_options: request_options
          )
          begin
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            CloudPDF::Types::DocPagesViewports200Response.load(response.body)
          else
            error_class = CloudPDF::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
