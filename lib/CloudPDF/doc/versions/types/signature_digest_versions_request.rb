...
module CloudPDF
  module Doc
    module Versions
      module Types
        class SignatureDigestVersionsRequest < Internal::Types::Model
          ...
          field :algorithm, -> { CloudPDF::Doc::Versions::Types::SignatureDigestVersionsRequestAlgorithm }, optional: false, nullable: false
